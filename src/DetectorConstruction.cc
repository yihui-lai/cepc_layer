...
G4VPhysicalVolume *DetectorConstruction::Construct()
{
  ...
  // ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
  G4VSolid *worldS = new G4Box("worldS", 50 * expHall_x, 50 * expHall_y, 500 * expHall_z);
...
//  G4Trd *ecalCrystalS_r = new G4Trd("ecalCrystalS_r", 0.5 * ecal_front_face, 0.5 * ecal_rear_face, 0.5 * ecal_front_face, 0.5 * ecal_rear_face, 0.5 * ecal_rear_length);
  //G4Box *ecalCrystalS_f = new G4Box("ecalCrystalS_f", 0.5*ecal_front_face, 0.5 * ecal_rear_face, 0.5 * ecal_front_length);
  //G4Box *ecalCrystalS_r = new G4Box("ecalCrystalS_r", 0.5*ecal_front_face, 0.5 * ecal_rear_face, 0.5 * ecal_rear_length);
  ...
  //
  /*
  double hole_diameter = 2.5*mm;
  double fiber_diameter = 0.8*mm;
*/
 // double distancechange = 2*6400*(hole_diameter + fiber_diameter + fiber_diameter + fiber_diameter);
  //double distancechange = sqrt(ecal_front_face * ecal_front_face + ecal_front_length * ecal_front_length) * abs(cos(pointingAngle * deg - atan(ecal_front_face / ecal_front_length))) / 2 - ecal_front_length * 0.5 + sqrt(ecal_front_face * ecal_front_face + ecal_rear_length * ecal_rear_length) * abs(cos(pointingAngle * deg - atan(ecal_front_face / ecal_rear_length))) / 2 - ecal_rear_length * 0.5;

  //G4Tubs *ecalCrystalS_f_hole = new G4Tubs("ecalCrystalS_f_hole", 0, hole_diameter * 0.5, ecal_front_length * 0.5, 0, 360 * deg);
//  G4Tubs *ecalCrystalS_f_fiber = new G4Tubs("ecalCrystalS_f_fiber", 0, fiber_diameter * 0.5, ecal_front_length * 0.5, 0, 360 * deg);
  //G4Tubs *ecalCrystalS_r_hole = new G4Tubs("ecalCrystalS_r_hole", 0, hole_diameter * 0.5, ecal_rear_length * 0.5, 0, 360 * deg);
//  G4Tubs *ecalCrystalS_r_fiber = new G4Tubs("ecalCrystalS_r_fiber", 0, fiber_diameter * 0.5, ecal_rear_length * 0.5, 0, 360 * deg);
  G4Box *ecalCrystalS_f_fiber = new G4Box("ecalCrystalS_f_fiber", 0.5*ecal_front_face, 0.5 * ecal_rear_face, 0.5 * fiber_diameter);
  G4Box *ecalCrystalS_r_fiber = new G4Box("ecalCrystalS_r_fiber", 0.5*ecal_front_face, 0.5 * ecal_rear_face, 0.5 * fiber_diameter);


  //G4ThreeVector zTrans1(0, fiber_diameter, 0);
  //G4ThreeVector zTrans2(-1 * sqrt(3) * fiber_diameter / 2., fiber_diameter / 2., 0);
  //G4ThreeVector zTrans3(-1 * sqrt(3) * fiber_diameter / 2., -1 * fiber_diameter / 2., 0);
  //G4ThreeVector zTrans4(0, -1 * fiber_diameter, 0);
  //G4ThreeVector zTrans5(sqrt(3) * fiber_diameter / 2., -1 * fiber_diameter / 2., 0);
  //G4ThreeVector zTrans6(sqrt(3) * fiber_diameter / 2., fiber_diameter / 2., 0);

//  G4SubtractionSolid *ecalCrystalS_f_absorb = new G4SubtractionSolid("ecalCrystalS_f_absorb", ecalCrystalS_f, ecalCrystalS_f_hole);
//  G4SubtractionSolid *ecalCrystalS_r_absorb = new G4SubtractionSolid("ecalCrystalS_r_absorb", ecalCrystalS_r, ecalCrystalS_r_hole);

  G4Box *ecalCrystalS_f_absorb = new G4Box("ecalCrystalS_f_absorb", 0.5*ecal_front_face, 0.5 * ecal_rear_face,  0.5*hole_diameter);
  G4Box *ecalCrystalS_r_absorb = new G4Box("ecalCrystalS_r_absorb", 0.5*ecal_front_face, 0.5 * ecal_rear_face,  0.5*hole_diameter);
  /*
  G4SubtractionSolid* ecalCrystalS_f_fiber1 = new G4SubtractionSolid("ecalCrystalS_f_fiber1", ecalCrystalS_f_hole, ecalCrystalS_f_fiber);
  G4SubtractionSolid* ecalCrystalS_f_fiber2 = new G4SubtractionSolid("ecalCrystalS_f_fiber2", ecalCrystalS_f_fiber1, ecalCrystalS_f_fiber,0,zTrans1);
  G4SubtractionSolid* ecalCrystalS_f_fiber3 = new G4SubtractionSolid("ecalCrystalS_f_fiber3", ecalCrystalS_f_fiber2, ecalCrystalS_f_fiber,0,zTrans2);
  G4SubtractionSolid* ecalCrystalS_f_fiber4 = new G4SubtractionSolid("ecalCrystalS_f_fiber4", ecalCrystalS_f_fiber3, ecalCrystalS_f_fiber,0,zTrans3);
  G4SubtractionSolid* ecalCrystalS_f_fiber5 = new G4SubtractionSolid("ecalCrystalS_f_fiber5", ecalCrystalS_f_fiber4, ecalCrystalS_f_fiber,0,zTrans4);
  G4SubtractionSolid* ecalCrystalS_f_fiber6 = new G4SubtractionSolid("ecalCrystalS_f_fiber6", ecalCrystalS_f_fiber5, ecalCrystalS_f_fiber,0,zTrans5);
  G4SubtractionSolid* ecalCrystalS_f_hollow = new G4SubtractionSolid("ecalCrystalS_f_hollow", ecalCrystalS_f_fiber6, ecalCrystalS_f_fiber,0,zTrans6);

  G4SubtractionSolid* ecalCrystalS_r_fiber1 = new G4SubtractionSolid("ecalCrystalS_r_fiber1", ecalCrystalS_r_hole, ecalCrystalS_r_fiber);
  G4SubtractionSolid* ecalCrystalS_r_fiber2 = new G4SubtractionSolid("ecalCrystalS_r_fiber2", ecalCrystalS_r_fiber1, ecalCrystalS_r_fiber,0,zTrans1);
  G4SubtractionSolid* ecalCrystalS_r_fiber3 = new G4SubtractionSolid("ecalCrystalS_r_fiber3", ecalCrystalS_r_fiber2, ecalCrystalS_r_fiber,0,zTrans2);
  G4SubtractionSolid* ecalCrystalS_r_fiber4 = new G4SubtractionSolid("ecalCrystalS_r_fiber4", ecalCrystalS_r_fiber3, ecalCrystalS_r_fiber,0,zTrans3);
  G4SubtractionSolid* ecalCrystalS_r_fiber5 = new G4SubtractionSolid("ecalCrystalS_r_fiber5", ecalCrystalS_r_fiber4, ecalCrystalS_r_fiber,0,zTrans4);
  G4SubtractionSolid* ecalCrystalS_r_fiber6 = new G4SubtractionSolid("ecalCrystalS_r_fiber6", ecalCrystalS_r_fiber5, ecalCrystalS_r_fiber,0,zTrans5);
  G4SubtractionSolid* ecalCrystalS_r_hollow = new G4SubtractionSolid("ecalCrystalS_r_hollow", ecalCrystalS_r_fiber6, ecalCrystalS_r_fiber,0,zTrans6);
*//*
  G4RotationMatrix rotn = G4RotationMatrix();
  G4Transform3D dTrans1 = G4Transform3D(rotn, zTrans1);
  G4Transform3D dTrans2 = G4Transform3D(rotn, zTrans2);
  G4Transform3D dTrans3 = G4Transform3D(rotn, zTrans3);
  G4Transform3D dTrans4 = G4Transform3D(rotn, zTrans4);
  G4Transform3D dTrans5 = G4Transform3D(rotn, zTrans5);
  G4Transform3D dTrans6 = G4Transform3D(rotn, zTrans6);

  G4MultiUnion *ecalCrystalS_f_fiber_scinti = new G4MultiUnion("ecalCrystalS_f_fiber_scinti");
  ecalCrystalS_f_fiber_scinti->AddNode(*ecalCrystalS_f_fiber, dTrans1);
  ecalCrystalS_f_fiber_scinti->AddNode(*ecalCrystalS_f_fiber, dTrans3);
  ecalCrystalS_f_fiber_scinti->AddNode(*ecalCrystalS_f_fiber, dTrans5);
  ecalCrystalS_f_fiber_scinti->Voxelize();

  G4MultiUnion *ecalCrystalS_r_fiber_scinti = new G4MultiUnion("ecalCrystalS_r_fiber_scinti");
  ecalCrystalS_r_fiber_scinti->AddNode(*ecalCrystalS_r_fiber, dTrans1);
  ecalCrystalS_r_fiber_scinti->AddNode(*ecalCrystalS_r_fiber, dTrans3);
  ecalCrystalS_r_fiber_scinti->AddNode(*ecalCrystalS_r_fiber, dTrans5);
  ecalCrystalS_r_fiber_scinti->Voxelize();

  G4MultiUnion *ecalCrystalS_f_fiber_cherenp = new G4MultiUnion("ecalCrystalS_f_fiber_cherenp");
  ecalCrystalS_f_fiber_cherenp->AddNode(*ecalCrystalS_f_fiber, dTrans2);
  ecalCrystalS_f_fiber_cherenp->AddNode(*ecalCrystalS_f_fiber, dTrans4);
  ecalCrystalS_f_fiber_cherenp->AddNode(*ecalCrystalS_f_fiber, dTrans6);
  ecalCrystalS_f_fiber_cherenp->Voxelize();

  G4MultiUnion *ecalCrystalS_r_fiber_cherenp = new G4MultiUnion("ecalCrystalS_r_fiber_cherenp");
  ecalCrystalS_r_fiber_cherenp->AddNode(*ecalCrystalS_r_fiber, dTrans2);
  ecalCrystalS_r_fiber_cherenp->AddNode(*ecalCrystalS_r_fiber, dTrans4);
  ecalCrystalS_r_fiber_cherenp->AddNode(*ecalCrystalS_r_fiber, dTrans6);
  ecalCrystalS_r_fiber_cherenp->Voxelize();
*/
  G4LogicalVolume *ecalCrystalL_f_absorb = new G4LogicalVolume(ecalCrystalS_f_absorb, EcalMaterial, "ecalCrystalL_f_absorb", 0, 0, 0);
  G4LogicalVolume *ecalCrystalL_r_absorb = new G4LogicalVolume(ecalCrystalS_r_absorb, EcalMaterial, "ecalCrystalL_r_absorb", 0, 0, 0);

  //  G4LogicalVolume* ecalCrystalL_f_hollow = new G4LogicalVolume(ecalCrystalS_f_hollow, MyMaterials::Air(), "ecalCrystalL_f_hollow", 0, 0, 0);
  //  G4LogicalVolume* ecalCrystalL_r_hollow = new G4LogicalVolume(ecalCrystalS_r_hollow, MyMaterials::Air(), "ecalCrystalL_r_hollow", 0, 0, 0);
  ...
  G4LogicalVolume *ecalCrystalL_r_fiber_scinti = new G4LogicalVolume(ecalCrystalS_r_fiber, ScintiMaterial, "ecalCrystalL_r_fiber_scinti", 0, 0, 0);
  G4LogicalVolume *ecalCrystalL_r_fiber_cherenc = new G4LogicalVolume(ecalCrystalS_r_fiber, CherencMaterial, "ecalCrystalL_r_fiber_cherenc", 0, 0, 0);
  G4LogicalVolume *ecalCrystalL_r_fiber_cherenp = new G4LogicalVolume(ecalCrystalS_r_fiber, CherenpMaterial, "ecalCrystalL_r_fiber_cherenp", 0, 0, 0);
  //
 ...
 // G4LogicalVolume *ecalDetL = new G4LogicalVolume(ecalDetS, DeMaterial, "ecalDetL", 0, 0, 0);
  ...
  //  G4VPhysicalVolume* ecalCrystalP_f_hollow[NECAL_CRYST];
  //  G4VPhysicalVolume* ecalCrystalP_r_hollow[NECAL_CRYST];

  G4VPhysicalVolume *ecalCrystalP_f_fiber_scinti[NECAL_CRYST];
  G4VPhysicalVolume *ecalCrystalP_r_fiber_scinti[NECAL_CRYST];

  G4VPhysicalVolume *ecalCrystalP_f_fiber_cherenc[NECAL_CRYST];
  G4VPhysicalVolume *ecalCrystalP_r_fiber_cherenc[NECAL_CRYST];

  G4VPhysicalVolume *ecalCrystalP_f_fiber_cherenp[NECAL_CRYST];
  G4VPhysicalVolume *ecalCrystalP_r_fiber_cherenp[NECAL_CRYST];
...
*/
      ...
      //ecalGapP_r[iCrystal] = new G4PVPlacement(piRotEcal, G4ThreeVector(x_pos[iCrystal], y_pos[iCrystal], ecal_timing_distance + 2*iCrystal*( hole_diameter+fiber_diameter +fiber_diameter +fiber_diameter) + gap_l * 0.5), ecalGapL, name, worldLV, false, 0);
      ...
      //ecalDetP_r[iCrystal] = new G4PVPlacement(piRotEcal, G4ThreeVector(x_pos[iCrystal], y_pos[iCrystal], ecal_timing_distance + 2*iCrystal*( hole_diameter+fiber_diameter +fiber_diameter +fiber_diameter) + gap_l + det_l * 0.5), ecalDetL, name, worldLV, false, 0);
...
*/
  ...
  G4VisAttributes *VisCrystalCore_r = new G4VisAttributes(brass);
...
*/
  ...
  ecalCrystalL_r_absorb->SetVisAttributes(VisCrystalCore_r);
  G4VisAttributes *VisFiber = new G4VisAttributes(white);
  ...
  ecalCrystalL_r_fiber_scinti->SetVisAttributes(VisFiber);
  ecalCrystalL_r_fiber_cherenc->SetVisAttributes(VisFiber);
  ecalCrystalL_r_fiber_cherenp->SetVisAttributes(VisFiber);
  //  ecalCrystalL_f_hollow -> SetVisAttributes(VisAttGap);
  //  ecalCrystalL_r_hollow -> SetVisAttributes(VisAttGap);
